...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID unique de la catégorie' }),
    (0, typeorm_1.PrimaryGeneratedColumn)('uuid'),
    __metadata("design:type", String)
], Category.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Nom de la catégorie' }),
    (0, typeorm_1.Column)({ unique: true }),
    __metadata("design:type", String)
], Category.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Description de la catégorie', required: false }),
    (0, typeorm_1.Column)({ nullable: true, type: 'text' }),
    __metadata("design:type", String)
], Category.prototype, "description", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Couleur associée à la catégorie (hex)', required: false }),
    (0, typeorm_1.Column)({ nullable: true, length: 7 }),
    __metadata("design:type", String)
], Category.prototype, "color", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Statut de la catégorie' }),
